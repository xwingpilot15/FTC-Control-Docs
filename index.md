[![badge](https://img.shields.io/discord/323516942814019595?label=CLICK%20TO%20JOIN%20OUR%20DISCORD)](https://discord.gg/NtTw8CR)

# FULL SETUP GUIDE

1. IDE Setup and repo download
	<br />-Make sure the right version of Java is installed on your computer. You can find a download link here: https://www.oracle.com/technetwork/java/javase/downloads/jdk8-downloads-2133151.html
	<br />-If you haven't yet, download Git: https://git-scm.com/		
<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-Select everything as default in the installer
	<br />-If you haven't yet, download Android Studio: https://developer.android.com/studio/index.html
		<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-Select standard installation and keep everything as default
	<br />-Open Android Studio and select "Check out project from Version Control"
	<br />-In the dropdown menu, select "Git"
	<br />-Paste this repository's URL in the "URL" blank
	<br />-Choose an empty folder to clone into for "Directory"
	<br />-Click "Clone"
	<br />-Once it finishes, hit "OK".
	<br />-Select "Create project from existing sources"
	<br />-Click "Next" through all of the prompts leaving everything how it is, then click "Finish" once you reach it.

2. Set up wireless code updater
	<br />-Go to File > Settings
	<br />-Go to Tools > External Tools
	<br />-Press the green plus sign to add a new external tool.
	<br />-Enter the following into their corresponding blanks; leave everything else as is.
		<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Name: Enable ADB over TCP/IP
		<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Program: \$ModuleSdkPath$/platform-tools/adb
		<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Arguments: tcpip 5555
		<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Working Directory: \$ProjectFileDir$
	<br />-Press the green plus sign to add another external tool.
	<br />-Enter the following into their corresponding blanks; leave everything else as is.
		<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Name: Connect to ADB over WiFi Direct
		<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Program: \$ModuleSdkPath$/platform-tools/adb
		<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Arguments: connect 192.168.49.1:5555
		<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(replace the "49" with "43" if you're using a Control Hub)
		<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Working Directory: \$ProjectFileDir$

## TEAMCODE ORGANIZATION:
<br />-drive is where team specific code for the opmodes and such go
<br />-teamLibSynced is framework code for both teams to use (i.e. Holonomic)
<br />-util is for utility classes (duh)
	
## To Use Wireless Code Updater
You will need to follow these steps each time you open Android Studio. The effects will last until Android Studio is closed or your computer disconnects from the phone or hub's Direct WiFi system.

1. Plug in the robot controller phone or control hub to your computer.
2. Go to Tools > External Tools
3. Select "Enable ADB over TCP/IP"
	<br />-Make sure the tool finishes with exit code 0
4. Connect to the corresponding Direct WiFi connection for the phone pair you are using. It should start with "DIRECT", "FIRST", or "FTC"
5. Make sure your program is selected in Android Studio (click the tab of one of your programs)
6. Select "Connect to ADB over WiFi Direct"
	<br />-Make sure the tool finishes with exit code 0
7. Unplug the phone or hub from your computer.
8. As long as Android Studio remains open and you stay connected to the Direct WiFi connection, you will no longer need to plug in the robot controller phone or control hub to update and test your code.

## To Send Your Code to Github ("Push")
1. Near the top of the screen, select VCS > Commit
2. Type in a commit description (what you have changed)
3. Next to the "Commit" button at the bottom, you should see a down arrow next to it; click on it and select "Commit and Push"
4. Click through the rest of the menus, leave everything as is.
5. Profit!

## To Update Your Local Copy of the Code ("Pull")
1. Go to command line/terminal in the tabs of Android Studio at the bottom and type in the command "git pull".
2. Do this whenever you switch a branch to make sure your copy of that branch is up to date and we don't have to merge old code and new code. Use git checkout <branch name> to switch branches.
3. Sell code as lakeshore real estate
4. Profit!
	
## In case of an update to the FTC libraries
If needed, use "git remote rm upstream" and "git remote rm origin" to remove the remotes to prevent duplicates.
1. git remote add upstream \<submodule repo link\> (atm it's https://github.com/FIRST-Tech-Challenge/SkyStone)
2. git pull upstream master
3. git remote add origin \<this repo link\>
